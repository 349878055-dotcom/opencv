...
| [`05_风格化/狗/情绪与品种合成约定.md`](../../../05_风格化/狗/情绪与品种合成约定.md) | 狗：通用情绪 × 品种 → styled |
| [`08_架构与验收/人格品种与Et正交审计.md`](../../08_架构与验收/人格品种与Et正交审计.md) | 品种/人格不改 E(t) 的审计结论 |
...
| 用 style 代替 PAD | 换情绪时 **气质读感** 跟不上 → 委屈和凶狠 styled 像 |
...
| 参考照与骨架 **解剖配准**（眼距/眼位/耳位） | [`底膜模板选择与标定专篇.md`](../06_工程底膜/底膜模板选择与标定专篇.md) | 预设 **`底膜包/`** + 客户 **`物种底膜模板.json`** | macro/PAD/style |
