...
> **类型：个性化 · 狗 · 单项** · id=`samoyed`

> **状态：🧠 脑补初稿（可逐份审定）** — 本文 **只管辖「萨摩耶/笑眼型」**（id=`samoyed`）；不与其它品种合并修订。
> **数值真源**：`预设资产/风格包/dog/samoyed/style.json` · schema `ecursor_style_v1`
...
定义 **萨摩耶/笑眼型** 的 **12 通道 base_offset / scale_factor**（及几何偏移如有），描述气质与验收。  
...
`预设资产/风格包/dog/samoyed/style.json`
