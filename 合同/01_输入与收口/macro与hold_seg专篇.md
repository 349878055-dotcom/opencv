...
| 文件 | 只管 |
|------|------|
| [`滑杆规范.md`](滑杆规范.md) | 字段定义、16 预设、L1 禁区 G1～G8、LLM 步进规则 |
| [`能量曲线_PAD与12通道映射.md`](能量曲线_PAD与12通道映射.md) | E(t) 与 PAD 正交、12 通道合成、客户改什么 |
| [`全量帧指令集规范.md`](全量帧指令集规范.md) | 150 帧四段语义、12 通道名单、烘焙 02 |
| [`08_架构与验收/公共层边界合同.md`](../08_架构与验收/公共层边界合同.md) | E(t) 在 `_shared/`，物种层只映射通道 |
...
| ✅ 本文件管 | ❌ 本文件不管 |
|------------|--------------|
| macro 六根的定义、语义、→ E(t) 映射 | PAD (P,A,D) 三维气质（见 [`能量曲线_PAD与12通道映射.md`](能量曲线_PAD与12通道映射.md)） |
| hold_seg 四字段、五种 shape、L1 shape 白名单 | 12 通道逐帧数值（出厂物，见 [`全量帧指令集规范.md`](全量帧指令集规范.md)） |
...
与 [`全量帧指令集规范.md`](全量帧指令集规范.md) §1 一致：
...
→ **macro/hold 专管 E(t)；PAD 专管 pad_scale[ch]**（见 [`08_架构与验收/人格品种与Et正交审计.md`](../08_架构与验收/人格品种与Et正交审计.md)）。
...
| 检查 | 期望 |
|------|------|
| [`滑杆规范.md`](滑杆规范.md) §3 macro 表 | 与本文 §4.2 一致；steady 标注 prior |
| [`能量曲线_PAD与12通道映射.md`](能量曲线_PAD与12通道映射.md) | 引用本文作 macro/hold 专篇 |
...
没有 1:1 表。6 macro + hold → **一条 E(t)**；再经 PAD 与物种规则 → 12 通道。见 [`能量曲线_PAD与12通道映射.md`](能量曲线_PAD与12通道映射.md) FAQ。
