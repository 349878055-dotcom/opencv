...
合同：合同/06_先验与质检/双质量标准_不要假不要平庸.md
"""
...
from gaze_engine.channel.micro_jitter import apply_jitter_to_channels
from gaze_engine.input.slider_schema import HoldSegment, SliderPacket, packet_to_compile_params
...
def _apply_third_eyelid(
    ...
    if ch not in channels:
        return
    from gaze_engine.envelope.envelope_compile import clamp_to_safe_range
