...
- `template_scales` / `template_structure` → [`gaze_engine/dog/dog/breed_matrix.json`](../../../gaze_engine/dog/dog/breed_matrix.json)
...
| 模块 | 职责 |
|------|------|
| [`dog/breed_matrix.json`](../../../gaze_engine/dog/dog/breed_matrix.json) | 矩阵真源（应与 style.json 一致） |
...
| 与矩阵 JSON 一致 | diff `dog/breed_matrix.json` | base/scale 一致 | P0 |
| 12 通道齐全 | 键集合 | 无缺失 | P0 |
