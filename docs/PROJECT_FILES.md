...
> **架构**: 双模驱动中间件（Eye-Figma Engine）— 详见 [`合同/08_架构与验收/流程设计.md`](合同/08_架构与验收/流程设计.md)
...
| | [`节奏说明书.md`](合同/04_通道与先验/节奏说明书.md) | **节奏说明书规范**：Wan 扩散引擎消费的节奏说明书格式与语义 |
| | [`节奏说明书编译器.md`](合同/04_通道与先验/节奏说明书编译器.md) | **节奏说明书编译器合同**：`rhythm_compiler.py` 的编译规则和验收标准 |
| | [`全量帧指令集规范.md`](合同/04_通道与先验/全量帧指令集规范.md) | **12 轨全量帧规范**：时间容器、真值层级、12 通道定义、分通道节奏合同 R01-R07、验收清单 |
| | [`眼眉真人默认律.md`](合同/04_通道与先验/眼眉真人默认律.md) | **Human Prior 合同**：正常人原则（过冲/底噪/延迟）、二阶扫视动力学、平庸三检 Q01-Q03 |
| | [`眼眉指令集_全局情绪节奏主钟.md`](合同/04_通道与先验/眼眉指令集_全局情绪节奏主钟.md) | **全局情绪节奏主钟**：眼眉指令集情绪节奏主钟定义 |
| **02\_情绪** | [`魅惑勾人.md`](合同/02_情绪与能量/魅惑勾人.md) | 魅惑·勾人情绪的专项规范 |
| **03\_工程底膜** | [`工程底膜合同.md`](合同/06_工程底膜/工程底膜合同.md) | **工程底膜合同**：RGB 三色分离格式协议 + 验收标准 |
| | [`工程底膜驱动规范.md`](合同/06_工程底膜/工程底膜驱动规范.md) | **工程底膜驱动规范**：`affine_renderer` 核心机制 + 注意事项 |
| **04\_接口** | [`UI设计原则.md`](合同/07_输出与扩散/UI设计原则.md) | 工作台交互设计原则 |
| | [`扩散引擎提示词拼装规范.md`](合同/07_输出与扩散/扩散引擎提示词拼装规范.md) | 扩散引擎提示词拼装规范 |
| **05\_人格化** | [`风格化偏向.md`](合同/05_风格化/风格化偏向.md) | 人格风格化偏向规则 |
| **06\_架构** | [`流程设计.md`](合同/08_架构与验收/流程设计.md) | **顶层架构设计**：双模驱动中间件架构说明 |
| | [`pomot合成规范.md`](合同/08_架构与验收/pomot合成规范.md) | Prompt 模板合成引擎规范 |
| | [`公共层边界合同.md`](合同/08_架构与验收/公共层边界合同.md) | **公共层边界合同**：公共层与物种层之间的接口边界 |
