...
> **架构**: 唯一宏观 [`合同/00_管线导读/00_从门户到扩散_管线总览.md`](合同/00_管线导读/00_从门户到扩散_管线总览.md)
...
| 目录 | 文件 | 内容 |
|------|------|------|
| — | [`合同规范.md`](合同/合同规范.md) | 统一合同模板规范 |
| — | [`README.md`](合同/README.md) | `合同/` 目录说明 |
| **01\_总纲** | [`滑杆规范.md`](合同/01_输入与收口/滑杆规范.md) | **滑杆总规范**：设计原则、SliderPacket 格式、宏观六滑杆、16 预设、L1 禁区 G1-G8、Python 映射链 |
| | [`节奏说明书.md`](合同/08_输出与扩散/节奏说明书.md) | **节奏说明书规范**：Wan 扩散引擎消费的节奏说明书格式与语义 |
| | [`节奏说明书编译器.md`](合同/08_输出与扩散/节奏说明书编译器.md) | **节奏说明书编译器合同**：`rhythm_compiler.py` 的编译规则和验收标准 |
| | [`01_十二通道与全量帧格式.md`](合同/04_通道编译/01_十二通道与全量帧格式.md) | **12 轨全量帧规范**：时间容器、真值层级、12 通道定义、分通道节奏合同 R01-R07、验收清单 |
| | [`人_眼眉先验与平庸三检.md`](合同/06_先验与质检/人_眼眉先验与平庸三检.md) | **Human Prior 合同**：正常人原则（过冲/底噪/延迟）、二阶扫视动力学、平庸三检 Q01-Q03 |
| | [`04_通道编译/README.md`](合同/04_通道编译/README.md) | S4 通道编译索引 |
| | [`01_十二通道与全量帧格式.md`](合同/04_通道编译/01_十二通道与全量帧格式.md) | 12 通道协议、150 帧、02 烘焙格式 |
| | [`狗/动态层编译与代码映射.md`](合同/04_通道编译/狗/动态层编译与代码映射.md) | 狗 S4 编译链 + P0 验收 |
| **02\_情绪** | [`魅惑勾人.md`](合同/02_情绪与能量/魅惑勾人.md) | 魅惑·勾人情绪的专项规范 |
| **03\_工程底膜** | [`工程底膜合同.md`](合同/07_工程底膜/工程底膜合同.md) | **工程底膜合同**：RGB 三色分离格式协议 + 验收标准 |
| | [`工程底膜驱动规范.md`](合同/07_工程底膜/工程底膜驱动规范.md) | **工程底膜驱动规范**：`affine_renderer` 核心机制 + 注意事项 |
| **04\_接口** | [`Pomot编辑专篇.md`](合同/08_输出与扩散/Pomot编辑专篇.md) | 工作台交互设计原则 |
| | [`扩散输出流程专篇.md`](合同/08_输出与扩散/扩散输出流程专篇.md) | 扩散输出流程专篇 |
| **05\_人格化** | [`00_风格化导读.md`](合同/05_风格化/00_风格化导读.md) | 人格风格化偏向规则 |
| **00\_管线导读** | [`00_从门户到扩散_管线总览.md`](合同/00_管线导读/00_从门户到扩散_管线总览.md) | **唯一宏观架构** |
| | [`Pomot编辑专篇.md`](合同/08_输出与扩散/Pomot编辑专篇.md) | Prompt 模板合成引擎规范 |
| | [`公共层边界合同.md`](合同/09_架构与验收/公共层边界合同.md) | **公共层边界合同**：公共层与物种层之间的接口边界 |
