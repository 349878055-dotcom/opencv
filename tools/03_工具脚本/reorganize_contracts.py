...
客户门户 / Pomot
    ...
    ▼ S6  先验质检     prior + Q01-Q03
    ▼ 视觉封装         02 烘焙 + 工程底膜 MP4
    ▼ 输出扩散         节拍表 + 04 Prompt → Wan
```
...
| **S4–S6** | [`04_通道与先验/`](../04_通道与先验/) | 12 通道、真人律、节拍表 | [`全量帧指令集规范.md`](../04_通道与先验/全量帧指令集规范.md) |
| **S5** | [`05_风格化/`](../05_风格化/) | 人格/品种 base+scale | [`风格化偏向.md`](../05_风格化/风格化偏向.md) |
| **视觉** | [`06_工程底膜/`](../06_工程底膜/) | RGB 三色底膜、affine | [`工程底膜合同.md`](../06_工程底膜/工程底膜合同.md) |
| **输出** | [`07_输出与扩散/`](../07_输出与扩散/) | 04 Prompt、UI | [`扩散引擎提示词拼装规范.md`](../07_输出与扩散/扩散引擎提示词拼装规范.md) |
